...
\tagline{Senior Software Engineer \& System}
...
\cvevent{}{Devops/Network Engineer}{}{}
\begin{itemize}
\item Setting up client infrastructure
\item Managing HPC workload manager
\item Troubleshooting from network to applicative stack
\item Stack : VMWare, Firewall, HPC, Slurm, netcat
\end{itemize}
...
\cvskill{Python}{5}
\cvskill{Ansible}{5}
\cvskill{Linux}{4} %% supports X.5 values.
...
\textbf{\color{accent}\large{Stack Network}}\par\medskip
\medskip
